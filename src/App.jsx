  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ margin: "10px 0 8px", color: "#c8a9b2", fontSize: 13 }}>
          {description}
        </p>
        <pre
          style={{
  ...
  return (
    ...
    >
      ...
      {isSupabaseConfigured && loading ? (
        <div style={{ padding: 24, color: "#666", fontFamily: "sans-serif", fontSize: 12 }}>인증 상태 확인 중...</div>
      ) : null}
      ...
      {isSupabaseConfigured && !loading && session ? (
        <Suspense
          fallback={
            <div style={{ padding: 24, color: "#666", fontFamily: "sans-serif", fontSize: 12 }}>
