...
export const DATA = {
  shot: [
    ...
    { id: "cs",  kr: "카우보이 샷 — 허벅지 위",       en: "thigh-up framing, mid-thigh to crown framing",              desc: "허벅지 중간까지 (웨스턴식)",          clipPct: 46 },
  ...
  height: [
    { id: "bev", kr: "버즈아이 뷰 — 수직 탑다운",     en: "top-down overhead view, directly overhead camera angle, 90-degree top-down perspective",                         desc: "완전 수직 하향, 탑뷰",    camPct: 98 },
    ...
    { id: "we",  kr: "웜스아이 뷰 — 바닥서 올려봄",     en: "extreme low-angle upward view, camera below subject looking straight up",               desc: "완전 수직 상향",          camPct: 3  },
  ],
  direction: [
    ...
    { id: "dq3", kr: "3/4 앞 (딥)",   en: "deep 60-70-degree oblique view, strong diagonal composition, pronounced depth, editorial fashion angle",                                           desc: "60~80° 깊은 사선 각도",     rotateY: 70  },
    ...
    { id: "q3b", kr: "3/4 뒤 — 135°",        en: "rear 45-degree oblique view, 135-degree angle, rear diagonal composition, shoulder and nape emphasis, mysterious back-angle portrait",                               desc: "어깨선 강조 후방 사선",     rotateY: 135 },
...
export const SUBJECT_TYPES = [
  {
    ...
    keywords: {
      height: [
        { phi: [0,12],    kr: "버즈아이 뷰 — 수직 탑다운",       en: "top-down overhead view" },
        ...
        { phi: [115,180], kr: "웜스아이 뷰 — 바닥서 올려봄",     en: "extreme low-angle upward view" },
      ],
      direction: [
        { theta: [0,18],    kr: "정면",              en: "facing camera" },
        { theta: [18,45],   kr: "살짝 턴 (15°)",     en: "slightly turned" },
        { theta: [45,80],   kr: "3/4 앞 — 대각선 45°", en: "45-degree oblique view" },
        { theta: [80,100],  kr: "측면 프로필 — 90°", en: "side profile" },
        { theta: [100,135], kr: "3/4 뒤 — 135°",     en: "rear 45-degree oblique view" },
      ...
      shot: [
        ...
        { r: [0.68,0.78], kr: "카우보이 샷 — 허벅지 위",       en: "thigh-up framing" },
  ...
  },
  {
    ...
    keywords: {
      ...
      direction: [
        ...
        { theta: [22,60],   kr: "3/4 뷰",    en: "45-degree oblique view" },
        { theta: [60,100],  kr: "측면",      en: "side profile" },
        { theta: [100,148], kr: "후방 3/4",  en: "rear 45-degree product view" },
