...
export const AR_PRESETS = [
  ...
  { id: "ar34", label: "3:4", value: "3:4", krFraming: "세로 포트레이트 프레이밍", enFraming: "portrait framing" },
...
export const ANGLE_PRESETS = [
  { id:"paparazzi",  label:"파파라치",   icon:"📸",
    phi:72, theta:35, r:0.38,
    desc:"자연스러운 포착, 비스듬히 옆에서",
    extraKw:"",
    shotTargetKr:"미디엄 샷" },
  { id:"idcard",     label:"증명사진",   icon:"🪪",
    phi:65, theta:0,  r:0.50,
    desc:"정면, 눈높이, 상반신",
    extraKw:"",
    shotTargetKr:"미디엄 클로즈업" },
  { id:"runway",     label:"런웨이",     icon:"👠",
    phi:60, theta:0,  r:0.18,
    desc:"정면, 눈높이, 풀바디",
    extraKw:"",
    shotTargetKr:"풀 바디 샷" },
  { id:"cctv",       label:"CCTV",       icon:"📹",
    phi:12, theta:15, r:0.07,
  ...
  { id:"insta",      label:"인스타감성", icon:"✨",
    phi:35, theta:40, r:0.37,
    desc:"위에서 대각선, 미디엄",
    extraKw:"",
    shotTargetKr:"미디엄 샷" },
  { id:"product",    label:"제품광고",   icon:"💎",
    phi:40, theta:30, r:0.64,
    desc:"45도 하이앵글, 클로즈업",
    extraKw:"",
    shotTargetKr:"클로즈업" },
  { id:"fisheye",    label:"어안렌즈",   icon:"🐟",
    phi:25, theta:20, r:0.08,
